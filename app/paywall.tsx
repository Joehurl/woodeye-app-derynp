...
const FEATURES = [
  {
    ...
    description: "Save and browse all your wood scans with no limits",
  },
  {
    icon: "🔍",
    title: "Advanced Identification",
    description: "Get deeper species insights, grain patterns, and wood properties",
  },
  {
    icon: "📊",
    title: "Detailed Reports",
    description: "Export full identification reports with care and usage tips",
  },
  {
    icon: "⭐",
    title: "Priority Support",
    description: "Get expert help identifying rare or unusual wood species",
  },
];
...
export default function PaywallScreen() {
  ...
  const handlePurchase = async () => {
    ...
    console.log('[WoodEye] Purchase button tapped, package:', selectedPackage.identifier, 'price:', selectedPackage.product.priceString);

    try {
      setPurchasing(true);
      const success = await purchasePackage(selectedPackage);
      if (success) {
        console.log('[WoodEye] Purchase succeeded for package:', selectedPackage.identifier);
        Alert.alert("Welcome!", "Thank you for your purchase.", [
          { text: "OK", onPress: () => router.replace("/(tabs)/(home)") },
        ]);
      } else {
        console.log('[WoodEye] Purchase returned false (cancelled or failed)');
      }
    } catch (error: any) {
      console.log('[WoodEye] Purchase error:', error.message);
  ...
  const handleRestore = async () => {
    console.log('[WoodEye] Restore purchases tapped');
    try {
      setRestoring(true);
      const restored = await restorePurchases();
      if (restored) {
        console.log('[WoodEye] Restore succeeded');
        Alert.alert("Restored!", "Your subscription has been restored.", [
          { text: "OK", onPress: () => router.replace("/(tabs)/(home)") },
        ]);
      } else {
        console.log('[WoodEye] Restore: no previous purchases found');
        Alert.alert(
          "No Purchases Found",
      ...
      console.log('[WoodEye] Restore error:', error.message);
  ...
  const handleClose = () => {
    console.log('[WoodEye] Paywall closed — navigating to home');
                ...
                {packages.map((pkg) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        console.log('[WoodEye] Paywall package selected:', pkg.identifier);
